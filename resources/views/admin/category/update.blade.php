    ...
    <section class="content">
        ...
        <div class="box">
            <div class="box-header with-border">
                <div class="box-body">
                    <form id="form-update-category" role="form" action="" method="POST" enctype="multipart/form-data">
                        @csrf
                        <div class="col-sm-8">
                            <div class="form-group {{ $errors->first('c_name') ? 'has-error' : '' }}">
                                <label for="name">Name <span class="text-danger">(*)</span></label>
                                <input type="text" class="form-control" name="c_name" value="{{ old('c_name', $category->c_name) }}" placeholder="Name ...">
                            ...
                            <div class="form-group">
                                ...
                                <select name="c_parent_id" class="form-control" id="">
                                    ...
                                    @foreach($categories as $item)
                                        <option value="{{ $item->id }}" {{ $item->id == $category->c_parent_id ? 'selected' : '' }}>
                                            <?php 
                                            $str = ''; 
                                ...
                                <div class="box-body block-images">
                                    ...
                                    <div style="position:relative;">
                                        <a class="btn btn-primary" href="javascript:;">
                                            Choose File...
                                            <input type="file" name="c_avatar" size="40" class="js-upload" 
