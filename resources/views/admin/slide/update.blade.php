...
@section('content')
    ...
    <div class="box-body block-images">
        <div style="margin-bottom: 10px">
            <img src="{{ pare_url_file($slide->sd_image ?? '') ?: '/images/no-image.jpg' }}" 
                 onerror="this.onerror=null;this.src='/images/no-image.jpg';" 
                 alt="" class="img-thumbnail" style="width: 100%; height: 400px;">
        </div>
        ...
        @if ($errors->first('sd_avatar'))
            <small class="text-danger" style="display: block;">
                {{ $errors->first('sd_avatar') }}
            </small>
        @else
            <small class="text-danger error-sd-avatar" style="display:none;"></small>
        @endif
    </div>
</div>
