                    ...
                    <form role="form" action="" method="POST" novalidate>
                        ...
                        <div class="col-sm-8">
                            <div class="form-group ">
                                ...
                                <span class="text-danger js-error-level"></span>
                            </div>
                        </div>
                        <div class="col-sm-8">
...
$(document).ready(function(){
    $('form[role="form"]').submit(function(e){
        ...
        // Kiểm tra level hợp lệ (1 hoặc 2)
        if(level !== '1' && level !== '2') {
            $('select[name="level"]').after('<span class="text-danger js-error">Vui lòng chọn chức vụ hợp lệ.</span>');
            valid = false;
        }

        // Kiểm tra password: nếu có nhập thì bắt buộc >= 8 ký tự
