...
<link rel="stylesheet" href="https://code.highcharts.com/css/highcharts.css">
    ...
    chart: {
        styledMode: false, // Tắt styledMode để có thể tùy chỉnh màu
    ...
    xAxis: {
        ...
        labels: {
            style: {
                color: '#ffffff' // chữ đen cho trục x
            }
        },
        lineColor: '#ffffff', // màu đường trục x
        tickColor: '#ffffff'
    },
    yAxis: {
        labels: {
        ...
        gridLineColor: '#e6e6e6' // màu lưới nhẹ
    },
    legend: {
        itemStyle: {
            color: '#ffffff'
