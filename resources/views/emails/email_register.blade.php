<div style="width: 100%;max-width: 600px;margin:0 auto">
    ...
    <div style="background: #f4f5f5;box-sizing: border-box;padding: 15px;border-top:1px solid #dedede;border-bottom: 1px solid #dedede">
        <p>Xin Chào {{ $name }}</p>
        <p>Chúng tôi xin chân thành cảm ơn Bạn đã tin tưởng đăng ký và sử dụng dịch vụ của laptopvn</p>
    ...
    <div style="background: #f4f5f5;box-sizing: border-box;padding: 15px">
        <p style="margin:2px 0;color: #333">Email : nguyenvana@gmail.com</p>
        <p style="margin:2px 0;color: #333">Phone : 0987654321</p>
        <p style="margin:2px 0;color: #333">Face : <a href="https://www.facebook.com/laptopvn">laptopvn</a></p>
    </div>
</div>