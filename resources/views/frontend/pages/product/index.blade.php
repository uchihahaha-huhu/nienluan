    ...
    <div class="product-list">
        ...
        <div class="right">
            ...
            <div class="order-tab">
                ...
                <div class="sort">
                    <div class="item">
                        <span class="title js-show-sort">Lọc & Sắp xếp <i class="fa fa-caret-down"></i></span>
                        <ul>
                            {{-- Các item filter giá --}}
                            @for($i = 1; $i <= 6; $i++) <li class="{{ Request::get('price') == $i ? "active" : "" }}">
                                <a href="{{ request()->fullUrlWithQuery(['price' =>  $i]) }}">
                                    {{  $i == 6 ? "Lớn hơn 100.000đ " : "Giá " . number_format($i * 20000,0,',','.')  ." đ" }}
                                </a>
                                </li>
                                @endfor
                                ...
                                {{-- Các item sắp xếp --}}
                                <li>
                                    <a class="{{ Request::get('sort') == 'desc' ? "active" : "" }}"
                                        href="{{ request()->fullUrlWithQuery(['sort'=> 'desc']) }}">
                                        Mới nhất
                                    </a>
                                </li>
                                <li>
                                    <a class="{{ Request::get('sort') == 'asc' ? "active" : "" }}"
