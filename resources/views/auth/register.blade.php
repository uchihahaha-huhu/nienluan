...
@section('script')
    <script type="text/javascript">
        ...
        $(document).ready(function(){
            $('.from_cart_register').submit(function(e) {
                ...
                // Kiểm tra phone tối thiểu 8 ký tự (chỉ số)
                if (phone.length < 8 || !/^\d+$/.test(phone)) {
                    alert('Số điện thoại phải có ít nhất 8 chữ số và chỉ gồm số');
                ...
                // Nếu muốn có thể bổ sung validate thêm tên, hoặc confirm password...
                return true; // submit form nếu vượt qua các validate
            });
        });
    </script>
@stop
